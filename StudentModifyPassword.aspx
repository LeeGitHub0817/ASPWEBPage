<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentModifyPassword.aspx.cs" Inherits="ModifyPassword" %>
...
<body background="PHOTOS/1.jpg">
    ...
    <p>
        ...
        <asp:Button ID="Button3" runat="server" CssClass="style17" 
            onclick="Button3_Click" Text="返回学生界面" CausesValidation="False" />
        </strong>
    </p>
    </form>
</body>
